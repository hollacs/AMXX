...
#define WEAPON_CLASS "weapon_p228"
#define WEAPON_EVENT "events/p228.sc"
#define WEAPON_ID CSW_P228
#define WEAPON_MAXCLIP 6
#define WEAPON_DEFAULT_GIVE 6
...
// Models
new const MODEL_W[] = "models/fai_zombie/weapons/w_m29.mdl";
new const MODEL_V[] = "models/fai_zombie/weapons/v_m29.mdl";
new const MODEL_P[] = "models/fai_zombie/weapons/p_m29.mdl";

// Sound
new const SOUND_FIRE[][] = {"weapons/m29-1.wav", "weapons/m29-2.wav"};
...
public plugin_precache()
{
	...
	precache_sound("weapons/deagle/draw.wav");
...
public plugin_init()
{
	...
	g_itemId = zb_register_extra_item("M29 Satan", 50, 7, ZB_TEAM_HUMAN);
